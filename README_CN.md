...
在**开始写作时**就好好读一遍 writing guide 和 figure guide，而不是等到最后。深入领会每条规则的实际含义。如果不理解 guideline 就直接跑 AI 检查，你会：
- 浪费时间修那些本来就该写对的东西
- 不理解 AI 为什么报这个问题
- 写作能力不会提升

正确的顺序是：
1. 写作前阅读并理解 guidelines
2. 自己充分检查，直到找不出任何问题
3. 做 peer review。和搭档讨论，互相学习。
4. 最后才跑 AI 检查，作为最终的安全网。

只有你深入理解了每条 guideline、并与搭档充分讨论过，才能真正看懂 AI 生成的 report。**从长远来看，这才能真正提升你的写作能力。从一开始就依赖 AI 则不会。**
